    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <svg
              className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-500 dark:text-slate-400 pointer-events-none"
            ...
            <input
              ...
              className="text-xs bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200
                         placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-lg pl-8 pr-3 py-2
                         w-40 focus:outline-none focus:border-blue-400 dark:focus:border-blue-500
                         focus:ring-1 focus:ring-blue-400 dark:focus:ring-blue-500 transition-all"
            />
          </div>

          {/* Filter buttons */}
          <div className="flex bg-slate-100 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-0.5 gap-0.5">
      ...
      {sortedTransactions.length === 0 ? (
        <div className="text-center py-16">
          <p className="text-3xl mb-3 text-slate-300 dark:text-slate-600">🔍</p>
            ...
            return (
              <div
                ...
                className="flex items-center justify-between px-3 py-3.5 rounded-xl
                           ...
                           hover:border-slate-200 dark:hover:border-slate-600 transition-all duration-150 group"
              >
                {/* Left: icon + details */}
